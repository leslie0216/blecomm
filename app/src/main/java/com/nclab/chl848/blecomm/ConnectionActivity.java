...
public class ConnectionActivity extends Activity {
    ...
    private void exit() {
        new AlertDialog.Builder(ConnectionActivity.this).setTitle("Warning").setMessage("Do you want to exit?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
